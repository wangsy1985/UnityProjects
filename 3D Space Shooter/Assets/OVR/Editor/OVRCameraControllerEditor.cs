...
/* JDC			
			...
			m_Component.MeshDistortion     	= EditorGUILayout.Toggle ("Mesh Distortion", m_Component.MeshDistortion);
			m_Component.ShowDistortionWire  = EditorGUILayout.Toggle ("Show Distortion Wire", m_Component.ShowDistortionWire);
*/				
#else
			m_Component.PredictionOn        = EditorGUILayout.Toggle ("Prediction On", m_Component.PredictionOn);
			m_Component.CallInPreRender     = EditorGUILayout.Toggle ("Call in Pre-Render", m_Component.CallInPreRender);
