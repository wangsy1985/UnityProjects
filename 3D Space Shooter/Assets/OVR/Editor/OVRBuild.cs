...
//-------------------------------------------------------------------------------------
// ***** OculusBuildIntegration
//
// OculusBuildIntegration allows for command line building of the Oculus unity integration demo (Shadowgun).
//
class OculusBuildIntegration
{
    static void PerformBuildAPK ()
    {
        string[] scenes = { "Assets/Shadowgun/_Level.unity" };
        EditorUserBuildSettings.SwitchActiveBuildTarget(BuildTarget.Android);
        BuildPipeline.BuildPlayer(scenes, "Shadowgun.apk", BuildTarget.Android, BuildOptions.None);
    }
}
//-------------------------------------------------------------------------------------
// ***** OculusBuildApp
