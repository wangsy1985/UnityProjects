...
public class OVRDevice : MonoBehaviour 
{
	...
	// PUBLIC
	public float InitialPredictionTime 							= 0.04f; // 40 ms
	...
	// NOTE: Smaller values give smaller screen render, but better 
	// fidelity
	private static float  DistortionFitScale 					= 1.0f;
	...
	{	
		...
		// Init
#if (!UNITY_ANDROID || UNITY_EDITOR)  // UnityJohn - SensorPlugin not included with VrLib, functionality replaced by TimeWarp
...
#if UNITY_ANDROID
/*
		// PGG Override for Samsung Galaxy S4 Phone	- J3	
		HResolution = 				1920;
		VResolution = 				1080;
		HScreenSize = 				0.111f;
		VScreenSize = 				0.063f;
		LensSeparationDistance = 	0.059f;
		...
		DistK3 = 					0.025f;
*/
		// PGG Override for Samsung Galaxy S4 Phone	- Samsung Prototype	
		HResolution = 				1920;
		VResolution = 				1080;
		HScreenSize = 				0.111f;
		VScreenSize = 				0.063f;
		LensSeparationDistance = 	0.062f;
		EyeToScreenDistance = 		0.0356f;
		DistK0 = 					1.0f;
		DistK1 = 					0.111f;
		DistK2 = 					0.139f;
		DistK3 = 					0.019f;
		
		// Keep the screen from fading out
	...
	{
#if UNITY_ANDROID   // UnityJohn - SensorPlugin not included with VrLib, functionality replaced by TimeWarp
		return true;
#else
